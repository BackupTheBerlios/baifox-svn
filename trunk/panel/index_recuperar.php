...
<?php } ?>
<br>
		<form method="post" action="recuperar_secure.php" id="form2" name="form2">
        ...
        <table width="340" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr> 
            <td>&nbsp;</td>
            <td> 
              <input type="submit" WIDTH="79" HEIGHT="25" value="Recuperar Contrase&ntilde;a"  STYLE="font-weight:normal;font-size:10px;">
            </td>
          </tr>
        </table>
				</td>
