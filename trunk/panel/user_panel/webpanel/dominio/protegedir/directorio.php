          ...
          <td colspan="3"> 
            <table width="100%" border="0" cellspacing="2" cellpadding="0">
              ...
              <tr align="center"> 
                ...
                <td align="left">
                  <input type="text" name="frmCuentaDestino2" class="boxBlur" onFocus="this.className='boxFocus'"  onBlur="this.className='boxBlur'" size="25">
                </td>
                <td width="15%" align="center"><a href="webpanel/<?php echo $_GET['grupo']; ?>/<?php echo $_GET['seccion']; ?>/delete.php?id=<?php echo $x; ?>&usuario=<?php echo $rs["cuenta_origen"]; ?>&dominio=<?php echo $_GET['dominio']; ?>"><img src="images/icn_grabar.gif" width="30" height="30" border="0"></a></td>
              </tr>
              <tr align="center"> 
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="0">
                <tr align="center"> 
                  ...
                  <td width="31%" align="left" bgcolor="#d6d6d6"> 
                    <input type="text" name="frmCuentaOrigen" class="boxBlur" onfocus="this.className='boxFocus'"  onblur="this.className='boxBlur'" size="15">
                  </td>
