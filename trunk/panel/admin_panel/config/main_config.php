...
define("_CFG_INTERFACE_VERSION","0.8.0");
...
define("_CFG_INTERFACE_GETTEXT_LOCALES",_CFG_INTERFACE_DIR."admin_panel/config/locale");
define("_CFG_INTERFACE_GETTEXT_DEFAULT","es_ES");
define("_CFG_INTERFACE_GETTEXT_ENCODING","ISO-8859-1");
