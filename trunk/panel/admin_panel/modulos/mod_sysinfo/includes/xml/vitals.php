...
//
// $Id: vitals.php 2 2004-08-20 14:21:01Z root $
...
function html_vitals () {
    ...
    $_text = '<table border="0" width="90%" align="center">'
           ...
           . '<tr><td valign="top"><font size="-1">'. $text['dversion'] .'</font></td><td><img width="16" height="16" alt="" src="modulos/mod_sysinfo/images/' . $XPath->getData('/phpsysinfo/Vitals/Distroicon') .'">&nbsp;<font size="-1">' . $XPath->getData('/phpsysinfo/Vitals/Distro') . '</font></td></tr>'
