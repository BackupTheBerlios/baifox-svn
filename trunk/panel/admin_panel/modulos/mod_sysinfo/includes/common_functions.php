...
// $Id: common_functions.php 2 2004-08-20 14:21:01Z root $
// HTML/XML Comment
function created_by () {
  global $VERSION;
...
function create_bargraph ($percent, $a, $b, $type = "") {
  if ($percent == 0) {
    return '<img height="' . BAR_HEIGHT . '" src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/bar_left.gif" alt="">' . '<img src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/bar_middle.gif" height="' . BAR_HEIGHT . '" width="1" alt="">' . '<img src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/bar_right.gif" height="' . BAR_HEIGHT . '" alt="">';
  } else if (($percent < 90) || ($type == "iso9660")) {
    return '<img height="' . BAR_HEIGHT . '" src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/bar_left.gif" alt="">' . '<img src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/bar_middle.gif" height="' . BAR_HEIGHT . '" width="' . ($a * $b) . '" alt="">' . '<img height="' . BAR_HEIGHT . '" src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/bar_right.gif" alt="">';
  } else {
    return '<img height="' . BAR_HEIGHT . '" src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/redbar_left.gif" alt="">' . '<img src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/redbar_middle.gif" height="' . BAR_HEIGHT . '" width="' . ($a * $b) . '" alt="">' . '<img height="' . BAR_HEIGHT . '" src="modulos/mod_sysinfo/templates/' . TEMPLATE_SET . '/images/redbar_right.gif" alt="">';
  } 
} 
