...
require(_CFG_INTERFACE_DIRMODULES.'mod_sysinfo/config.php'); // get the config file
...
require(_CFG_INTERFACE_DIRMODULES.'mod_sysinfo/includes/lang/' . $lng . '.php'); // get our language include
...
require(_CFG_INTERFACE_DIRMODULES.'mod_sysinfo/includes/common_functions.php'); // Set of common functions used through out the app
...
if ($template == 'xml') {
  ...
  if (PHPGROUPWARE != 1) {
    require(_CFG_INTERFACE_DIRMODULES.'mod_sysinfo/includes/class.Template.inc.php'); // template library
  } 
