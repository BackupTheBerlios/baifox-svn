...
#
LogFile="{APACHE_LOGS}{DOMINIO}{APACHE_STRING_AWSTATS}"
...
#
HostAliases="{DOMINIO} 127.0.0.1 REGEX[{DOMINIO_SIN}\.{DOMINIO_EXT}$]"
...
#
DirData="{AWSTATS_DATADIR}{DOMINIO}"
...
# Default: ""
#
AllowAccessFromWebToFollowingAuthenticatedUsers="{AWSTATS_USUARIO}"
