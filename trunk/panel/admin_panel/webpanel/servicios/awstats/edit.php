      ...
      <td valign="top" align="center"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="3" height="121" align="center" bordercolor="#000000">
          ...
          <tr align="left" bgcolor="#FFFFFF"> 
            ...
            <td> 
              <input type="text" name="frmUsuario" size="15" maxlength="14" value="<?php echo awstats_usuariohtpasswd($_GET['dominio']); ?>"><font face="Arial, Helvetica, sans-serif" size="2"> Max 14 car.</font>
            </td>
          </tr>
          <tr align="left" bgcolor="#FFFFFF"> 
