...
<form method="POST" action="webpanel/<?php echo $_GET['grupo']."/".$_GET['seccion']; ?>/sub_save.php?id=0" name="formulario">
<input type="hidden" name="frmCFG_ESTADO" value="1">
  <font size="2" face="Arial, Helvetica, sans-serif">A&ntilde;adir Nuevo Subdominio</font><br>
<br>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="3" height="121" align="center" bordercolor="#000000">
          ...
          <tr align="left" bgcolor="#FFFFFF"> 
            ...
            <td height="25" align="left"> 
              <input type="text" name="frmDominio" size="50" onkeyup="crear_subdocumentroot(this.form,'<?php echo _CFG_APACHE_DOCUMENTROOT; ?>');crear_subserveralias(this.form);">
            </td>
          </tr>
          <tr align="left" bgcolor="#FFFFFF"> 
