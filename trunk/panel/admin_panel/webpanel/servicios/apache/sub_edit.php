...
?>
<form method="POST" action="webpanel/<?php echo $_GET['grupo']."/".$_GET['seccion']; ?>/sub_save.php?id=<?php echo $_GET['id']; ?>">
...
<input type="hidden" name="frmCFG_DOCUMENTROOT" value="<?php echo $rs["CFG_DOCUMENTROOT"]; ?>">
  <font size="2" face="Arial, Helvetica, sans-serif">Modificar Subdominio</font><br>
<br>
